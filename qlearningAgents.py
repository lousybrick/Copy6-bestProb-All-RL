...
class QLearningAgent(ReinforcementAgent):
    ...
    def getAction(self, state):
        ...
        if not legalActions:
          return None
        isExplore = util.flipCoin(self.epsilon)
        if isExplore: 
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Get max value of all actions for next state
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feature, val in self.stateFeatures.items():
          sumIter += val * self.weights[feature]
        return sumIter
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature, val in self.stateFeatures.items():
          self.weights[feature] = self.weights[feature] + self.alpha * loss * val
